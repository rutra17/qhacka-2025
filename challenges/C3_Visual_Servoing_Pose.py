...
NB_PATH = pathlib.Path(__file__).with_name("C3_Visual_Servoing_Pose.ipynb")
...
solve = _ns.get("solve")
if solve is None:
    raise ImportError("[solve](http://_vscodecontentref_/1) not found in notebook: C3_Visual_Servoing_Pose.ipynb")