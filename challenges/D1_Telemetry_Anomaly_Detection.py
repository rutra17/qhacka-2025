...
NB_PATH = pathlib.Path(__file__).with_name("D1_Telemetry_Anomaly_Detection.ipynb")
...
solve = _ns.get("solve")
if solve is None:
    raise ImportError("`solve` not found in notebook: D1_Telemetry_Anomaly_Detection.ipynb")
